...
Models = namedtuple("Models", ["pi", "q", "v"])
...
class SacAgent(BaseAgent):
    ...
    def initialize(self, env_spaces, share_memory=False, global_B=1, env_ranks=None):
        ...
        try:
            ...
            print("Tied encoder weights.")
        except torch.nn.modules.module.ModuleAttributeError:
            print("Couldn't tie encoder weights.")
        # self.model.encoder = self.q_model.encoder
    ...
    def q(self, observation, prev_action, prev_reward, action):
        ...
        q1, q2 = self.q_model(*model_inputs)
